class SiloRed_5_Group: RscControlsGroupNoScrollbars {
    ...
    onLoad = "uiNamespace setVariable ['carrierstrike_main_silored_5_group', _this select 0]";
    ...
    class controls {
        class SiloRed_5: RscPictureKeepAspect {
            ...
            onLoad = "uiNamespace setVariable ['carrierstrike_main_silored_5', _this select 0]";
