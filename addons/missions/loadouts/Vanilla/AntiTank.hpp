...
class Tier1_West_Antitank_Pacific
{
...
class Tier1_West_Antitank_Woodland
{
...
class Tier1_East_Antitank_Urban
{
...
class Tier1_East_Antitank_Pacific
{
    displayName = "Anti Tank (Pacific)";
    icon = "";
    role = QGVAR(AntiTank);
